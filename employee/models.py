...
class Address(models.Model):
    emp_id=models.ForeignKey(to=Details,on_delete=models.CASCADE)
    ...
    # class Meta:  #class meta has an ordering attribute that orders the result in an ascending order based on the emp_id.
    #     ordering = ('id',)   #'ordering' must be a tuple or list
